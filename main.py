...
app.include_router(patient_router, prefix=settings.API_V1_STR, tags=["👤 Patients"])
app.include_router(doctor_router, prefix=settings.API_V1_STR, tags=["🩺 Doctors"])
app.include_router(appointment_router, prefix=settings.API_V1_STR, tags=["📅 Appointments"])
app.include_router(ehr_router, prefix=settings.API_V1_STR, tags=["📁 Electronic Health Records (EHR)"])
app.include_router(clinical_note_router, prefix=settings.API_V1_STR, tags=["📝 Clinical Notes"])
app.include_router(laboratory_router, prefix=settings.API_V1_STR, tags=["🔬 Laboratory & Diagnostics"])
app.include_router(prescription_router, prefix=settings.API_V1_STR, tags=["💊 Prescriptions"])
app.include_router(billing_router, prefix=settings.API_V1_STR, tags=["💳 Billing & Invoices"])
app.include_router(insurance_router, prefix=settings.API_V1_STR, tags=["🛡️ Health Insurance"])
app.include_router(pharmacy_router, prefix=settings.API_V1_STR, tags=["🏪 Pharmacy & Medications"])
app.include_router(ward_router, prefix=settings.API_V1_STR, tags=["🛏️ Wards & Bed Occupancy"])
app.include_router(telemedicine_router, prefix=settings.API_V1_STR, tags=["💻 Telemedicine & Remote Care"])
app.include_router(notification_router, prefix=settings.API_V1_STR, tags=["🔔 Alerts & Notifications"])
app.include_router(audit_log_router, prefix=settings.API_V1_STR, tags=["📜 Audit Trails"])
app.include_router(patient_portal_router, prefix=settings.API_V1_STR, tags=["🌐 Patient Portals"])
app.include_router(analytics_router, prefix=settings.API_V1_STR, tags=["📊 Hospital Analytics"])
app.include_router(procedure_router, prefix=settings.API_V1_STR, tags=["🩹 Surgical Procedures"])
app.include_router(vitals_router, prefix=settings.API_V1_STR, tags=["🫀 Patient Vitals"])
app.include_router(allergen_router, prefix=settings.API_V1_STR, tags=["⚠️ Allergies & Allergen Records"])
app.include_router(emergency_router, prefix=settings.API_V1_STR, tags=["🚨 Emergency Response"])
app.include_router(nutrition_router, prefix=settings.API_V1_STR, tags=["🍎 Diets & Nutrition Planning"])
app.include_router(immunization_router, prefix=settings.API_V1_STR, tags=["💉 Immunizations & Vaccines"])
app.include_router(security_router, prefix=settings.API_V1_STR, tags=["🔒 Security & Access Control"])
