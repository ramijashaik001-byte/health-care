# app/api/patient.py
"""
FastAPI Router defining REST API endpoints for the Patient controller.
...
def list_patients(
    ...
    """Retrieve paginated lists of Patient records."""
...
@router.get("/{entity_id}", response_model=PatientResponse, status_code=status.HTTP_200_OK)
def get_patient_by_id(entity_id: int, db: Session = Depends(get_db)):
    """Fetch a single Patient record by unique ID."""
    service = PatientService(db)
    return service.get_by_id(entity_id)

@router.post("/", response_model=PatientResponse, status_code=status.HTTP_201_CREATED)
def create_patient(obj_in: PatientCreate, db: Session = Depends(get_db)):
    """Submit and register a new Patient entity."""
    service = PatientService(db)
    return service.create(obj_in)

@router.put("/{entity_id}", response_model=PatientResponse, status_code=status.HTTP_200_OK)
def update_patient(entity_id: int, obj_in: PatientUpdate, db: Session = Depends(get_db)):
    """Update properties of an existing Patient record."""
    service = PatientService(db)
    return service.update(entity_id, obj_in)

@router.delete("/{entity_id}", response_model=PatientResponse, status_code=status.HTTP_200_OK)
def delete_patient(entity_id: int, db: Session = Depends(get_db)):
    """Remove a Patient record from system data storage."""
    service = PatientService(db)
    return service.delete(entity_id)

@router.post("/{entity_id}/verify-stage-0", status_code=status.HTTP_200_OK)
def verify_patient_stage_0(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_threshold_0(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_stage_1(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_threshold_1(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_stage_2(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_threshold_2(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_stage_3(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_threshold_3(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_stage_4(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_threshold_4(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_stage_5(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_threshold_5(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_stage_6(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_threshold_6(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_stage_7(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_threshold_7(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_stage_8(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_threshold_8(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_stage_9(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_threshold_9(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_stage_10(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_threshold_10(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_stage_11(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_threshold_11(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_stage_12(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_threshold_12(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_stage_13(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_threshold_13(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_stage_14(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_threshold_14(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_stage_15(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_threshold_15(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_stage_16(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_threshold_16(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_stage_17(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_threshold_17(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_stage_18(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_threshold_18(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_stage_19(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_threshold_19(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_stage_20(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_threshold_20(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_stage_21(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_threshold_21(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_stage_22(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_threshold_22(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_stage_23(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_threshold_23(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_stage_24(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_threshold_24(entity_id: int, value: float, db: Session = Depends(get_db)):
