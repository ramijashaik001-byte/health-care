# app/api/procedure.py
"""
FastAPI Router defining REST API endpoints for the Procedure controller.
...
@router.get("/", response_model=ProcedureListResponse, status_code=status.HTTP_200_OK)
def list_procedures(
    ...
    """Retrieve paginated lists of Procedure records."""
...
@router.get("/{entity_id}", response_model=ProcedureResponse, status_code=status.HTTP_200_OK)
def get_procedure_by_id(entity_id: int, db: Session = Depends(get_db)):
    """Fetch a single Procedure record by unique ID."""
    service = ProcedureService(db)
    return service.get_by_id(entity_id)

@router.post("/", response_model=ProcedureResponse, status_code=status.HTTP_201_CREATED)
def create_procedure(obj_in: ProcedureCreate, db: Session = Depends(get_db)):
    """Submit and register a new Procedure entity."""
    service = ProcedureService(db)
    return service.create(obj_in)

@router.put("/{entity_id}", response_model=ProcedureResponse, status_code=status.HTTP_200_OK)
def update_procedure(entity_id: int, obj_in: ProcedureUpdate, db: Session = Depends(get_db)):
    """Update properties of an existing Procedure record."""
    service = ProcedureService(db)
    return service.update(entity_id, obj_in)

@router.delete("/{entity_id}", response_model=ProcedureResponse, status_code=status.HTTP_200_OK)
def delete_procedure(entity_id: int, db: Session = Depends(get_db)):
    """Remove a Procedure record from system data storage."""
    service = ProcedureService(db)
    return service.delete(entity_id)

@router.post("/{entity_id}/verify-stage-0", status_code=status.HTTP_200_OK)
def verify_procedure_stage_0(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_procedure_threshold_0(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_procedure_stage_1(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_procedure_threshold_1(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_procedure_stage_2(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_procedure_threshold_2(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_procedure_stage_3(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_procedure_threshold_3(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_procedure_stage_4(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_procedure_threshold_4(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_procedure_stage_5(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_procedure_threshold_5(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_procedure_stage_6(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_procedure_threshold_6(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_procedure_stage_7(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_procedure_threshold_7(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_procedure_stage_8(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_procedure_threshold_8(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_procedure_stage_9(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_procedure_threshold_9(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_procedure_stage_10(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_procedure_threshold_10(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_procedure_stage_11(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_procedure_threshold_11(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_procedure_stage_12(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_procedure_threshold_12(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_procedure_stage_13(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_procedure_threshold_13(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_procedure_stage_14(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_procedure_threshold_14(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_procedure_stage_15(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_procedure_threshold_15(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_procedure_stage_16(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_procedure_threshold_16(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_procedure_stage_17(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_procedure_threshold_17(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_procedure_stage_18(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_procedure_threshold_18(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_procedure_stage_19(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_procedure_threshold_19(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_procedure_stage_20(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_procedure_threshold_20(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_procedure_stage_21(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_procedure_threshold_21(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_procedure_stage_22(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_procedure_threshold_22(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_procedure_stage_23(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_procedure_threshold_23(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_procedure_stage_24(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_procedure_threshold_24(entity_id: int, value: float, db: Session = Depends(get_db)):
