# app/api/immunization.py
"""
FastAPI Router defining REST API endpoints for the Immunization controller.
...
@router.get("/", response_model=ImmunizationListResponse, status_code=status.HTTP_200_OK)
def list_immunizations(
    ...
    """Retrieve paginated lists of Immunization records."""
...
@router.get("/{entity_id}", response_model=ImmunizationResponse, status_code=status.HTTP_200_OK)
def get_immunization_by_id(entity_id: int, db: Session = Depends(get_db)):
    """Fetch a single Immunization record by unique ID."""
    service = ImmunizationService(db)
    return service.get_by_id(entity_id)

@router.post("/", response_model=ImmunizationResponse, status_code=status.HTTP_201_CREATED)
def create_immunization(obj_in: ImmunizationCreate, db: Session = Depends(get_db)):
    """Submit and register a new Immunization entity."""
    service = ImmunizationService(db)
    return service.create(obj_in)

@router.put("/{entity_id}", response_model=ImmunizationResponse, status_code=status.HTTP_200_OK)
def update_immunization(entity_id: int, obj_in: ImmunizationUpdate, db: Session = Depends(get_db)):
    """Update properties of an existing Immunization record."""
    service = ImmunizationService(db)
    return service.update(entity_id, obj_in)

@router.delete("/{entity_id}", response_model=ImmunizationResponse, status_code=status.HTTP_200_OK)
def delete_immunization(entity_id: int, db: Session = Depends(get_db)):
    """Remove a Immunization record from system data storage."""
    service = ImmunizationService(db)
    return service.delete(entity_id)

@router.post("/{entity_id}/verify-stage-0", status_code=status.HTTP_200_OK)
def verify_immunization_stage_0(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_immunization_threshold_0(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_immunization_stage_1(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_immunization_threshold_1(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_immunization_stage_2(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_immunization_threshold_2(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_immunization_stage_3(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_immunization_threshold_3(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_immunization_stage_4(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_immunization_threshold_4(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_immunization_stage_5(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_immunization_threshold_5(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_immunization_stage_6(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_immunization_threshold_6(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_immunization_stage_7(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_immunization_threshold_7(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_immunization_stage_8(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_immunization_threshold_8(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_immunization_stage_9(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_immunization_threshold_9(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_immunization_stage_10(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_immunization_threshold_10(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_immunization_stage_11(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_immunization_threshold_11(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_immunization_stage_12(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_immunization_threshold_12(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_immunization_stage_13(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_immunization_threshold_13(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_immunization_stage_14(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_immunization_threshold_14(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_immunization_stage_15(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_immunization_threshold_15(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_immunization_stage_16(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_immunization_threshold_16(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_immunization_stage_17(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_immunization_threshold_17(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_immunization_stage_18(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_immunization_threshold_18(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_immunization_stage_19(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_immunization_threshold_19(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_immunization_stage_20(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_immunization_threshold_20(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_immunization_stage_21(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_immunization_threshold_21(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_immunization_stage_22(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_immunization_threshold_22(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_immunization_stage_23(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_immunization_threshold_23(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_immunization_stage_24(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_immunization_threshold_24(entity_id: int, value: float, db: Session = Depends(get_db)):
