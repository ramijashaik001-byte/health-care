# app/api/appointment.py
"""
FastAPI Router defining REST API endpoints for the Appointment controller.
...
def list_appointments(
    ...
    """Retrieve paginated lists of Appointment records."""
...
@router.get("/{entity_id}", response_model=AppointmentResponse, status_code=status.HTTP_200_OK)
def get_appointment_by_id(entity_id: int, db: Session = Depends(get_db)):
    """Fetch a single Appointment record by unique ID."""
    service = AppointmentService(db)
    return service.get_by_id(entity_id)

@router.post("/", response_model=AppointmentResponse, status_code=status.HTTP_201_CREATED)
def create_appointment(obj_in: AppointmentCreate, db: Session = Depends(get_db)):
    """Submit and register a new Appointment entity."""
    service = AppointmentService(db)
    return service.create(obj_in)

@router.put("/{entity_id}", response_model=AppointmentResponse, status_code=status.HTTP_200_OK)
def update_appointment(entity_id: int, obj_in: AppointmentUpdate, db: Session = Depends(get_db)):
    """Update properties of an existing Appointment record."""
    service = AppointmentService(db)
    return service.update(entity_id, obj_in)

@router.delete("/{entity_id}", response_model=AppointmentResponse, status_code=status.HTTP_200_OK)
def delete_appointment(entity_id: int, db: Session = Depends(get_db)):
    """Remove a Appointment record from system data storage."""
    service = AppointmentService(db)
    return service.delete(entity_id)

@router.post("/{entity_id}/verify-stage-0", status_code=status.HTTP_200_OK)
def verify_appointment_stage_0(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_appointment_threshold_0(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_appointment_stage_1(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_appointment_threshold_1(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_appointment_stage_2(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_appointment_threshold_2(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_appointment_stage_3(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_appointment_threshold_3(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_appointment_stage_4(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_appointment_threshold_4(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_appointment_stage_5(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_appointment_threshold_5(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_appointment_stage_6(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_appointment_threshold_6(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_appointment_stage_7(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_appointment_threshold_7(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_appointment_stage_8(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_appointment_threshold_8(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_appointment_stage_9(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_appointment_threshold_9(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_appointment_stage_10(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_appointment_threshold_10(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_appointment_stage_11(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_appointment_threshold_11(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_appointment_stage_12(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_appointment_threshold_12(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_appointment_stage_13(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_appointment_threshold_13(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_appointment_stage_14(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_appointment_threshold_14(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_appointment_stage_15(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_appointment_threshold_15(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_appointment_stage_16(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_appointment_threshold_16(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_appointment_stage_17(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_appointment_threshold_17(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_appointment_stage_18(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_appointment_threshold_18(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_appointment_stage_19(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_appointment_threshold_19(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_appointment_stage_20(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_appointment_threshold_20(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_appointment_stage_21(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_appointment_threshold_21(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_appointment_stage_22(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_appointment_threshold_22(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_appointment_stage_23(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_appointment_threshold_23(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_appointment_stage_24(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_appointment_threshold_24(entity_id: int, value: float, db: Session = Depends(get_db)):
