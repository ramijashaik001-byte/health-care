...
"""
FastAPI Router defining REST API endpoints for the PatientPortal controller.
...
router = APIRouter(prefix="/patient_portal", tags=["PatientPortal"])

@router.get("/", response_model=PatientPortalListResponse, status_code=status.HTTP_200_OK)
def list_patient_portals(
    ...
    """Retrieve paginated lists of PatientPortal records."""
    filters = PatientPortalFilter(
        search=search,
        limit=limit,
        offset=offset,
        sort_by=sort_by,
    ...
    return PatientPortalListResponse(
        items=items,
        total_count=total,
        limit=limit,
        offset=offset
...
@router.get("/{entity_id}", response_model=PatientPortalResponse, status_code=status.HTTP_200_OK)
def get_patient_portal_by_id(entity_id: int, db: Session = Depends(get_db)):
    """Fetch a single PatientPortal record by unique ID."""
    service = PatientPortalService(db)
    return service.get_by_id(entity_id)

@router.post("/", response_model=PatientPortalResponse, status_code=status.HTTP_201_CREATED)
def create_patient_portal(obj_in: PatientPortalCreate, db: Session = Depends(get_db)):
    """Submit and register a new PatientPortal entity."""
    service = PatientPortalService(db)
    return service.create(obj_in)

@router.put("/{entity_id}", response_model=PatientPortalResponse, status_code=status.HTTP_200_OK)
def update_patient_portal(entity_id: int, obj_in: PatientPortalUpdate, db: Session = Depends(get_db)):
    """Update properties of an existing PatientPortal record."""
    service = PatientPortalService(db)
    return service.update(entity_id, obj_in)

@router.delete("/{entity_id}", response_model=PatientPortalResponse, status_code=status.HTTP_200_OK)
def delete_patient_portal(entity_id: int, db: Session = Depends(get_db)):
    """Remove a PatientPortal record from system data storage."""
    service = PatientPortalService(db)
    return service.delete(entity_id)

@router.post("/{entity_id}/verify-stage-0", status_code=status.HTTP_200_OK)
def verify_patient_portal_stage_0(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_portal_threshold_0(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_portal_stage_1(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_portal_threshold_1(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_portal_stage_2(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_portal_threshold_2(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_portal_stage_3(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_portal_threshold_3(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_portal_stage_4(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_portal_threshold_4(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_portal_stage_5(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_portal_threshold_5(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_portal_stage_6(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_portal_threshold_6(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_portal_stage_7(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_portal_threshold_7(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_portal_stage_8(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_portal_threshold_8(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_portal_stage_9(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_portal_threshold_9(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_portal_stage_10(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_portal_threshold_10(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_portal_stage_11(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_portal_threshold_11(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_portal_stage_12(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_portal_threshold_12(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_portal_stage_13(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_portal_threshold_13(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_portal_stage_14(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_portal_threshold_14(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_portal_stage_15(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_portal_threshold_15(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_portal_stage_16(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_portal_threshold_16(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_portal_stage_17(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_portal_threshold_17(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_portal_stage_18(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_portal_threshold_18(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_portal_stage_19(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_portal_threshold_19(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_portal_stage_20(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_portal_threshold_20(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_portal_stage_21(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_portal_threshold_21(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_portal_stage_22(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_portal_threshold_22(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_portal_stage_23(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_portal_threshold_23(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_patient_portal_stage_24(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_patient_portal_threshold_24(entity_id: int, value: float, db: Session = Depends(get_db)):
