# app/api/doctor.py
"""
FastAPI Router defining REST API endpoints for the Doctor controller.
...
def list_doctors(
    ...
    """Retrieve paginated lists of Doctor records."""
...
@router.get("/{entity_id}", response_model=DoctorResponse, status_code=status.HTTP_200_OK)
def get_doctor_by_id(entity_id: int, db: Session = Depends(get_db)):
    """Fetch a single Doctor record by unique ID."""
    service = DoctorService(db)
    return service.get_by_id(entity_id)

@router.post("/", response_model=DoctorResponse, status_code=status.HTTP_201_CREATED)
def create_doctor(obj_in: DoctorCreate, db: Session = Depends(get_db)):
    """Submit and register a new Doctor entity."""
    service = DoctorService(db)
    return service.create(obj_in)

@router.put("/{entity_id}", response_model=DoctorResponse, status_code=status.HTTP_200_OK)
def update_doctor(entity_id: int, obj_in: DoctorUpdate, db: Session = Depends(get_db)):
    """Update properties of an existing Doctor record."""
    service = DoctorService(db)
    return service.update(entity_id, obj_in)

@router.delete("/{entity_id}", response_model=DoctorResponse, status_code=status.HTTP_200_OK)
def delete_doctor(entity_id: int, db: Session = Depends(get_db)):
    """Remove a Doctor record from system data storage."""
    service = DoctorService(db)
    return service.delete(entity_id)

@router.post("/{entity_id}/verify-stage-0", status_code=status.HTTP_200_OK)
def verify_doctor_stage_0(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_doctor_threshold_0(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_doctor_stage_1(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_doctor_threshold_1(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_doctor_stage_2(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_doctor_threshold_2(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_doctor_stage_3(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_doctor_threshold_3(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_doctor_stage_4(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_doctor_threshold_4(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_doctor_stage_5(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_doctor_threshold_5(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_doctor_stage_6(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_doctor_threshold_6(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_doctor_stage_7(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_doctor_threshold_7(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_doctor_stage_8(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_doctor_threshold_8(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_doctor_stage_9(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_doctor_threshold_9(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_doctor_stage_10(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_doctor_threshold_10(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_doctor_stage_11(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_doctor_threshold_11(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_doctor_stage_12(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_doctor_threshold_12(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_doctor_stage_13(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_doctor_threshold_13(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_doctor_stage_14(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_doctor_threshold_14(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_doctor_stage_15(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_doctor_threshold_15(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_doctor_stage_16(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_doctor_threshold_16(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_doctor_stage_17(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_doctor_threshold_17(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_doctor_stage_18(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_doctor_threshold_18(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_doctor_stage_19(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_doctor_threshold_19(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_doctor_stage_20(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_doctor_threshold_20(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_doctor_stage_21(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_doctor_threshold_21(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_doctor_stage_22(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_doctor_threshold_22(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_doctor_stage_23(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_doctor_threshold_23(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_doctor_stage_24(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_doctor_threshold_24(entity_id: int, value: float, db: Session = Depends(get_db)):
