# app/api/security.py
"""
FastAPI Router defining REST API endpoints for the Security controller.
...
@router.get("/", response_model=SecurityListResponse, status_code=status.HTTP_200_OK)
def list_securities(
    ...
    """Retrieve paginated lists of Security records."""
...
@router.get("/{entity_id}", response_model=SecurityResponse, status_code=status.HTTP_200_OK)
def get_security_by_id(entity_id: int, db: Session = Depends(get_db)):
    """Fetch a single Security record by unique ID."""
    service = SecurityService(db)
    return service.get_by_id(entity_id)

@router.post("/", response_model=SecurityResponse, status_code=status.HTTP_201_CREATED)
def create_security(obj_in: SecurityCreate, db: Session = Depends(get_db)):
    """Submit and register a new Security entity."""
    service = SecurityService(db)
    return service.create(obj_in)

@router.put("/{entity_id}", response_model=SecurityResponse, status_code=status.HTTP_200_OK)
def update_security(entity_id: int, obj_in: SecurityUpdate, db: Session = Depends(get_db)):
    """Update properties of an existing Security record."""
    service = SecurityService(db)
    return service.update(entity_id, obj_in)

@router.delete("/{entity_id}", response_model=SecurityResponse, status_code=status.HTTP_200_OK)
def delete_security(entity_id: int, db: Session = Depends(get_db)):
    """Remove a Security record from system data storage."""
    service = SecurityService(db)
    return service.delete(entity_id)

@router.post("/{entity_id}/verify-stage-0", status_code=status.HTTP_200_OK)
def verify_security_stage_0(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_security_threshold_0(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_security_stage_1(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_security_threshold_1(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_security_stage_2(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_security_threshold_2(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_security_stage_3(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_security_threshold_3(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_security_stage_4(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_security_threshold_4(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_security_stage_5(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_security_threshold_5(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_security_stage_6(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_security_threshold_6(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_security_stage_7(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_security_threshold_7(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_security_stage_8(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_security_threshold_8(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_security_stage_9(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_security_threshold_9(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_security_stage_10(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_security_threshold_10(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_security_stage_11(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_security_threshold_11(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_security_stage_12(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_security_threshold_12(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_security_stage_13(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_security_threshold_13(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_security_stage_14(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_security_threshold_14(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_security_stage_15(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_security_threshold_15(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_security_stage_16(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_security_threshold_16(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_security_stage_17(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_security_threshold_17(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_security_stage_18(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_security_threshold_18(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_security_stage_19(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_security_threshold_19(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_security_stage_20(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_security_threshold_20(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_security_stage_21(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_security_threshold_21(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_security_stage_22(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_security_threshold_22(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_security_stage_23(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_security_threshold_23(entity_id: int, value: float, db: Session = Depends(get_db)):
...
def verify_security_stage_24(entity_id: int, db: Session = Depends(get_db)):
...
def evaluate_security_threshold_24(entity_id: int, value: float, db: Session = Depends(get_db)):
