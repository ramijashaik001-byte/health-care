# app/models/ward.py
"""
SQLAlchemy ORM Model representing the Ward entity.
...
class WardModel(Base):
    ...
    ward_type = Column(String(50), nullable=False, index=True)
    total_beds = Column(Integer, nullable=False)
    occupied_beds = Column(Integer, nullable=True, default=0)
    charge_per_day = Column(Float, nullable=False)
