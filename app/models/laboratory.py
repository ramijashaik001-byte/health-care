...
"""
SQLAlchemy ORM Model representing the Laboratory entity.
...
class LaboratoryModel(Base):
    ...
    def __repr__(self) -> str:
        return f"<LaboratoryModel(id={self.id})>"
