# app/models/ehr.py
"""
SQLAlchemy ORM Model representing the EHR entity.
...
class EHRModel(Base):
    ...
    diagnosis = Column(String(500), nullable=False, index=True)
    treatment_plan = Column(Text, nullable=True)
    notes = Column(Text, nullable=True)
    symptoms = Column(Text, nullable=True)
    created_by_doctor_id = Column(Integer, ForeignKey('doctors.id'), nullable=False)
