# app/models/patient_portal.py
"""
SQLAlchemy ORM Model representing the PatientPortal entity.
...
class PatientPortalModel(Base):
    __tablename__ = "patient_portals"
    ...
    def __repr__(self) -> str:
        return f"<PatientPortalModel(id={self.id})>"
