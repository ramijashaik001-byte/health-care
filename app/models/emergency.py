...
"""
SQLAlchemy ORM Model representing the Emergency entity.
...
class EmergencyModel(Base):
    ...
    triage_level = Column(Integer, nullable=False, index=True)
    ambulance_unit = Column(String(100), nullable=True)
    ...
    def __repr__(self) -> str:
        return f"<EmergencyModel(id={self.id})>"
