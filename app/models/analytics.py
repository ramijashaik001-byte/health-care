...
"""
SQLAlchemy ORM Model representing the Analytics entity.
...
class AnalyticsModel(Base):
    ...
    revenue_metric = Column(Float, nullable=True, default=0.0)
    occupancy_metric = Column(Float, nullable=True, default=0.0)
    ...
    def __repr__(self) -> str:
        return f"<AnalyticsModel(id={self.id})>"
