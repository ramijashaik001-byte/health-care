...
"""
SQLAlchemy ORM Model representing the Vitals entity.
...
class VitalsModel(Base):
    ...
    def __repr__(self) -> str:
        return f"<VitalsModel(id={self.id})>"
