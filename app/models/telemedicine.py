...
"""
SQLAlchemy ORM Model representing the Telemedicine entity.
...
class TelemedicineModel(Base):
    ...
    call_quality = Column(String(50), nullable=True)
    ...
    def __repr__(self) -> str:
        return f"<TelemedicineModel(id={self.id})>"
