...
"""
SQLAlchemy ORM Model representing the Procedure entity.
...
class ProcedureModel(Base):
    ...
    procedure_name = Column(String(200), nullable=False, index=True)
    ...
    def __repr__(self) -> str:
        return f"<ProcedureModel(id={self.id})>"
