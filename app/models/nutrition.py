...
"""
SQLAlchemy ORM Model representing the Nutrition entity.
...
class NutritionModel(Base):
    ...
    meal_schedule = Column(Text, nullable=True)
    ...
    def __repr__(self) -> str:
        return f"<NutritionModel(id={self.id})>"
