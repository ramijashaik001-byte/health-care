...
"""
SQLAlchemy ORM Model representing the Allergen entity.
...
class AllergenModel(Base):
    __tablename__ = "allergens"

    id = Column(Integer, primary_key=True, index=True)
    patient_id = Column(Integer, ForeignKey('patients.id'), nullable=False)
    substance = Column(String(200), nullable=False, index=True)
    severity = Column(String(50), nullable=False)
    reaction_type = Column(String(200), nullable=True)
    ...
    def __repr__(self) -> str:
        return f"<AllergenModel(id={self.id})>"
