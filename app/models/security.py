...
"""
SQLAlchemy ORM Model representing the Security entity.
...
class SecurityModel(Base):
    ...
    def __repr__(self) -> str:
        return f"<SecurityModel(id={self.id})>"
