...
"""
SQLAlchemy ORM Model representing the Billing entity.
...
class BillingModel(Base):
    ...
    status = Column(String(50), nullable=False, index=True, default='Unpaid')
    ...
    def __repr__(self) -> str:
        return f"<BillingModel(id={self.id})>"
