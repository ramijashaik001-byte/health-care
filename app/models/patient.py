...
"""
SQLAlchemy ORM Model representing the Patient entity.
...
class PatientModel(Base):
    ...
    appointments = relationship('AppointmentModel')
    ehrs = relationship('EHRModel')
    billings = relationship('BillingModel')
    ...
    def __repr__(self) -> str:
        return f"<PatientModel(id={self.id})>"
