...
"""
SQLAlchemy ORM Model representing the AuditLog entity.
...
class AuditLogModel(Base):
    ...
    def __repr__(self) -> str:
        return f"<AuditLogModel(id={self.id})>"
