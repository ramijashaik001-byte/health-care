...
"""
SQLAlchemy ORM Model representing the Appointment entity.
...
class AppointmentModel(Base):
    ...
    is_telehealth = Column(Boolean, nullable=True, default=False)
    ...
    def __repr__(self) -> str:
        return f"<AppointmentModel(id={self.id})>"
