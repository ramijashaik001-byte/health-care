...
"""
SQLAlchemy ORM Model representing the Prescription entity.
...
class PrescriptionModel(Base):
    ...
    refills_allowed = Column(Integer, nullable=True, default=0)
    ...
    def __repr__(self) -> str:
        return f"<PrescriptionModel(id={self.id})>"
