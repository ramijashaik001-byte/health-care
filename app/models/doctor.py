...
"""
SQLAlchemy ORM Model representing the Doctor entity.
...
class DoctorModel(Base):
    ...
    clinical_notes = relationship('ClinicalNoteModel')
    ...
    def __repr__(self) -> str:
        return f"<DoctorModel(id={self.id})>"
