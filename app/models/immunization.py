...
"""
SQLAlchemy ORM Model representing the Immunization entity.
...
class ImmunizationModel(Base):
    ...
    next_dose_due = Column(Date, nullable=True)
    ...
    def __repr__(self) -> str:
        return f"<ImmunizationModel(id={self.id})>"
