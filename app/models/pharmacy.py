...
"""
SQLAlchemy ORM Model representing the Pharmacy entity.
...
class PharmacyModel(Base):
    ...
    drug_name = Column(String(200), nullable=False, unique=True)
    generic_name = Column(String(200), nullable=True)
    manufacturer = Column(String(150), nullable=True)
    quantity_in_stock = Column(Integer, nullable=False, default=0)
    unit_price = Column(Float, nullable=False)
    reorder_level = Column(Integer, nullable=True, default=10)
    ...
    def __repr__(self) -> str:
        return f"<PharmacyModel(id={self.id})>"
