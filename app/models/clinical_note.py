...
"""
SQLAlchemy ORM Model representing the ClinicalNote entity.
...
class ClinicalNoteModel(Base):
    ...
    is_finalized = Column(Boolean, nullable=True, default=False)
    ...
    def __repr__(self) -> str:
        return f"<ClinicalNoteModel(id={self.id})>"
