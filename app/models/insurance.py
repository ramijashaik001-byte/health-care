...
"""
SQLAlchemy ORM Model representing the Insurance entity.
...
class InsuranceModel(Base):
    ...
    copay_amount = Column(Float, nullable=True, default=0.0)
    deductible_amount = Column(Float, nullable=True, default=0.0)
    ...
    def __repr__(self) -> str:
        return f"<InsuranceModel(id={self.id})>"
