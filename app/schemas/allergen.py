...
class AllergenBase(BaseModel):
    patient_id: Optional[int] = Field(..., description='The patient_id field of Allergen')
    substance: Optional[str] = Field(..., description='The substance field of Allergen')
    severity: Optional[str] = Field(..., description='The severity field of Allergen')
    reaction_type: Optional[str] = Field(None, description='The reaction_type field of Allergen')
    first_observed: Optional[date] = Field(None, description='The first_observed field of Allergen')

    @field_validator("substance")
    @classmethod
    def validate_substance_length(cls, v: Optional[str]) -> Optional[str]:
        """Ensures string input does not exceed database columns limitations."""
        if v is not None and len(v.strip()) == 0:
            raise ValueError("substance cannot be empty or pure whitespace")
        return v

    @field_validator("severity")
    @classmethod
    def validate_severity_length(cls, v: Optional[str]) -> Optional[str]:
        """Ensures string input does not exceed database columns limitations."""
        if v is not None and len(v.strip()) == 0:
            raise ValueError("severity cannot be empty or pure whitespace")
        return v

    @field_validator("reaction_type")
    @classmethod
    def validate_reaction_type_length(cls, v: Optional[str]) -> Optional[str]:
        """Ensures string input does not exceed database columns limitations."""
        if v is not None and len(v.strip()) == 0:
            raise ValueError("reaction_type cannot be empty or pure whitespace")
        return v

class AllergenCreate(AllergenBase):
    """Validation schema for creating a new Allergen entity."""
    patient_id: int = Field(..., description='patient_id must be provided')
    substance: str = Field(..., description='substance must be provided')
    severity: str = Field(..., description='severity must be provided')

class AllergenUpdate(AllergenBase):
    """Validation schema for updating existing Allergen entities. All fields are optional."""
    pass
...
class AllergenExtendedSchemaMetadataClass0(BaseModel):
    ...
    module_owner: str = Field("CareFlow_Allergen_Service", description="Service domain owner")
    version_tag: int = 0
    is_active: bool = True
    attributes_dictionary: Optional[dict] = None

class AllergenExtendedSchemaMetadataClass1(BaseModel):
...
class AllergenExtendedSchemaMetadataClass2(BaseModel):
...
class AllergenExtendedSchemaMetadataClass3(BaseModel):
...
class AllergenExtendedSchemaMetadataClass4(BaseModel):
...
class AllergenExtendedSchemaMetadataClass5(BaseModel):
...
class AllergenExtendedSchemaMetadataClass6(BaseModel):
...
class AllergenExtendedSchemaMetadataClass7(BaseModel):
...
class AllergenExtendedSchemaMetadataClass8(BaseModel):
...
class AllergenExtendedSchemaMetadataClass9(BaseModel):
...
class AllergenExtendedSchemaMetadataClass10(BaseModel):
...
class AllergenExtendedSchemaMetadataClass11(BaseModel):
...
class AllergenExtendedSchemaMetadataClass12(BaseModel):
...
class AllergenExtendedSchemaMetadataClass13(BaseModel):
...
class AllergenExtendedSchemaMetadataClass14(BaseModel):
...
class AllergenExtendedSchemaMetadataClass15(BaseModel):
...
class AllergenExtendedSchemaMetadataClass16(BaseModel):
...
class AllergenExtendedSchemaMetadataClass17(BaseModel):
...
class AllergenExtendedSchemaMetadataClass18(BaseModel):
...
class AllergenExtendedSchemaMetadataClass19(BaseModel):
...
class AllergenExtendedSchemaMetadataClass20(BaseModel):
...
class AllergenExtendedSchemaMetadataClass21(BaseModel):
...
class AllergenExtendedSchemaMetadataClass22(BaseModel):
...
class AllergenExtendedSchemaMetadataClass23(BaseModel):
...
class AllergenExtendedSchemaMetadataClass24(BaseModel):
