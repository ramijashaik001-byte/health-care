...
class VitalsBase(BaseModel):
    patient_id: Optional[int] = Field(..., description='The patient_id field of Vitals')
    recorded_at: Optional[datetime] = Field(..., description='The recorded_at field of Vitals')
    temperature: Optional[float] = Field(..., description='The temperature field of Vitals')
    blood_pressure_systolic: Optional[int] = Field(..., description='The blood_pressure_systolic field of Vitals')
    blood_pressure_diastolic: Optional[int] = Field(..., description='The blood_pressure_diastolic field of Vitals')
    heart_rate: Optional[int] = Field(..., description='The heart_rate field of Vitals')
    oxygen_saturation: Optional[float] = Field(None, description='The oxygen_saturation field of Vitals')
    respiratory_rate: Optional[int] = Field(None, description='The respiratory_rate field of Vitals')

class VitalsCreate(VitalsBase):
    """Validation schema for creating a new Vitals entity."""
    patient_id: int = Field(..., description='patient_id must be provided')
    recorded_at: datetime = Field(..., description='recorded_at must be provided')
    temperature: float = Field(..., description='temperature must be provided')
    blood_pressure_systolic: int = Field(..., description='blood_pressure_systolic must be provided')
    blood_pressure_diastolic: int = Field(..., description='blood_pressure_diastolic must be provided')
    heart_rate: int = Field(..., description='heart_rate must be provided')

class VitalsUpdate(VitalsBase):
    """Validation schema for updating existing Vitals entities. All fields are optional."""
    pass

class VitalsFilter(BaseModel):
...
class VitalsExtendedSchemaMetadataClass0(BaseModel):
    ...
    module_owner: str = Field("CareFlow_Vitals_Service", description="Service domain owner")
    version_tag: int = 0
    is_active: bool = True
    attributes_dictionary: Optional[dict] = None

class VitalsExtendedSchemaMetadataClass1(BaseModel):
...
class VitalsExtendedSchemaMetadataClass2(BaseModel):
...
class VitalsExtendedSchemaMetadataClass3(BaseModel):
...
class VitalsExtendedSchemaMetadataClass4(BaseModel):
...
class VitalsExtendedSchemaMetadataClass5(BaseModel):
...
class VitalsExtendedSchemaMetadataClass6(BaseModel):
...
class VitalsExtendedSchemaMetadataClass7(BaseModel):
...
class VitalsExtendedSchemaMetadataClass8(BaseModel):
...
class VitalsExtendedSchemaMetadataClass9(BaseModel):
...
class VitalsExtendedSchemaMetadataClass10(BaseModel):
...
class VitalsExtendedSchemaMetadataClass11(BaseModel):
...
class VitalsExtendedSchemaMetadataClass12(BaseModel):
...
class VitalsExtendedSchemaMetadataClass13(BaseModel):
...
class VitalsExtendedSchemaMetadataClass14(BaseModel):
...
class VitalsExtendedSchemaMetadataClass15(BaseModel):
...
class VitalsExtendedSchemaMetadataClass16(BaseModel):
...
class VitalsExtendedSchemaMetadataClass17(BaseModel):
...
class VitalsExtendedSchemaMetadataClass18(BaseModel):
...
class VitalsExtendedSchemaMetadataClass19(BaseModel):
...
class VitalsExtendedSchemaMetadataClass20(BaseModel):
...
class VitalsExtendedSchemaMetadataClass21(BaseModel):
...
class VitalsExtendedSchemaMetadataClass22(BaseModel):
...
class VitalsExtendedSchemaMetadataClass23(BaseModel):
...
class VitalsExtendedSchemaMetadataClass24(BaseModel):
