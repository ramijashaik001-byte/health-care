...
class ClinicalNoteBase(BaseModel):
    appointment_id: Optional[int] = Field(..., description='The appointment_id field of ClinicalNote')
    doctor_id: Optional[int] = Field(..., description='The doctor_id field of ClinicalNote')
    subjective: Optional[str] = Field(..., description='The subjective field of ClinicalNote')
    objective: Optional[str] = Field(..., description='The objective field of ClinicalNote')
    assessment: Optional[str] = Field(..., description='The assessment field of ClinicalNote')
    plan: Optional[str] = Field(..., description='The plan field of ClinicalNote')
    is_finalized: Optional[bool] = Field(None, description='The is_finalized field of ClinicalNote')

    @field_validator("subjective")
    @classmethod
    def validate_subjective_length(cls, v: Optional[str]) -> Optional[str]:
        """Ensures string input does not exceed database columns limitations."""
        if v is not None and len(v.strip()) == 0:
            raise ValueError("subjective cannot be empty or pure whitespace")
        return v

    @field_validator("objective")
    @classmethod
    def validate_objective_length(cls, v: Optional[str]) -> Optional[str]:
        """Ensures string input does not exceed database columns limitations."""
        if v is not None and len(v.strip()) == 0:
            raise ValueError("objective cannot be empty or pure whitespace")
        return v

    @field_validator("assessment")
    @classmethod
    def validate_assessment_length(cls, v: Optional[str]) -> Optional[str]:
        """Ensures string input does not exceed database columns limitations."""
        if v is not None and len(v.strip()) == 0:
            raise ValueError("assessment cannot be empty or pure whitespace")
        return v

    @field_validator("plan")
    @classmethod
    def validate_plan_length(cls, v: Optional[str]) -> Optional[str]:
        """Ensures string input does not exceed database columns limitations."""
        if v is not None and len(v.strip()) == 0:
            raise ValueError("plan cannot be empty or pure whitespace")
        return v

class ClinicalNoteCreate(ClinicalNoteBase):
    """Validation schema for creating a new ClinicalNote entity."""
    ...
    subjective: str = Field(..., description='subjective must be provided')
    objective: str = Field(..., description='objective must be provided')
    assessment: str = Field(..., description='assessment must be provided')
    plan: str = Field(..., description='plan must be provided')

class ClinicalNoteUpdate(ClinicalNoteBase):
    """Validation schema for updating existing ClinicalNote entities. All fields are optional."""
    pass
...
class ClinicalNoteExtendedSchemaMetadataClass0(BaseModel):
    ...
    module_owner: str = Field("CareFlow_ClinicalNote_Service", description="Service domain owner")
    version_tag: int = 0
    is_active: bool = True
    attributes_dictionary: Optional[dict] = None

class ClinicalNoteExtendedSchemaMetadataClass1(BaseModel):
...
class ClinicalNoteExtendedSchemaMetadataClass2(BaseModel):
...
class ClinicalNoteExtendedSchemaMetadataClass3(BaseModel):
...
class ClinicalNoteExtendedSchemaMetadataClass4(BaseModel):
...
class ClinicalNoteExtendedSchemaMetadataClass5(BaseModel):
...
class ClinicalNoteExtendedSchemaMetadataClass6(BaseModel):
...
class ClinicalNoteExtendedSchemaMetadataClass7(BaseModel):
...
class ClinicalNoteExtendedSchemaMetadataClass8(BaseModel):
...
class ClinicalNoteExtendedSchemaMetadataClass9(BaseModel):
...
class ClinicalNoteExtendedSchemaMetadataClass10(BaseModel):
...
class ClinicalNoteExtendedSchemaMetadataClass11(BaseModel):
...
class ClinicalNoteExtendedSchemaMetadataClass12(BaseModel):
...
class ClinicalNoteExtendedSchemaMetadataClass13(BaseModel):
...
class ClinicalNoteExtendedSchemaMetadataClass14(BaseModel):
...
class ClinicalNoteExtendedSchemaMetadataClass15(BaseModel):
...
class ClinicalNoteExtendedSchemaMetadataClass16(BaseModel):
...
class ClinicalNoteExtendedSchemaMetadataClass17(BaseModel):
...
class ClinicalNoteExtendedSchemaMetadataClass18(BaseModel):
...
class ClinicalNoteExtendedSchemaMetadataClass19(BaseModel):
...
class ClinicalNoteExtendedSchemaMetadataClass20(BaseModel):
...
class ClinicalNoteExtendedSchemaMetadataClass21(BaseModel):
...
class ClinicalNoteExtendedSchemaMetadataClass22(BaseModel):
...
class ClinicalNoteExtendedSchemaMetadataClass23(BaseModel):
...
class ClinicalNoteExtendedSchemaMetadataClass24(BaseModel):
